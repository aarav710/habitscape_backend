...
func DateCreated(v time.Time) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func DateCreatedEQ(v time.Time) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldDateCreated), v))
	})
}
...
func DateCreatedNEQ(v time.Time) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func DateCreatedIn(vs ...time.Time) predicate.Comment {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func DateCreatedNotIn(vs ...time.Time) predicate.Comment {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func DateCreatedGT(v time.Time) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func DateCreatedGTE(v time.Time) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func DateCreatedLT(v time.Time) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func DateCreatedLTE(v time.Time) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
