...
func (pc *PostCreate) SetPhotoURL(s string) *PostCreate {
...
func (pc *PostCreate) SetDateCreated(t time.Time) *PostCreate {
	pc.mutation.SetDateCreated(t)
	return pc
}

// SetNillableDateCreated sets the "date_created" field if the given value is not nil.
func (pc *PostCreate) SetNillableDateCreated(t *time.Time) *PostCreate {
	if t != nil {
		pc.SetDateCreated(*t)
	}
	return pc
...
func (pc *PostCreate) SetHabitID(id int) *PostCreate {
	pc.mutation.SetHabitID(id)
	return pc
}

// SetHabit sets the "habit" edge to the Habit entity.
func (pc *PostCreate) SetHabit(h *Habit) *PostCreate {
	return pc.SetHabitID(h.ID)
}
...
func (pc *PostCreate) check() error {
	if _, ok := pc.mutation.PhotoURL(); !ok {
		return &ValidationError{Name: "photo_url", err: errors.New(`ent: missing required field "Post.photo_url"`)}
	}
	...
	if _, ok := pc.mutation.DateCreated(); !ok {
		return &ValidationError{Name: "date_created", err: errors.New(`ent: missing required field "Post.date_created"`)}
	}
	if _, ok := pc.mutation.HabitID(); !ok {
		return &ValidationError{Name: "habit", err: errors.New(`ent: missing required edge "Post.habit"`)}
	}
...
func (pc *PostCreate) createSpec() (*Post, *sqlgraph.CreateSpec) {
	...
	if nodes := pc.mutation.HabitIDs(); len(nodes) > 0 {
